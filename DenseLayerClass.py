...
class Layer_Dense:
    ...
    def forward(self, inputs):
        #Calculatr output values from inputs, weights and biases
...
activation1 = Activation_ReLU()
dense2 = Layer_Dense(3,3) # second dense layers, 3 inputs, 3 outputs
activation2 = Activation_Softmax()
...
best_dense2_wbiases = dense2.biases.copy()
...
for iteration in range(30000):
    ...
    # Calculatr accuracy from output of activation2 and targets
    # calculate values along first axis
    predictions = np.argmax(activation2.output, axis=1)
    accuracy = np.mean(predictions == y)
